message( "Exploratory Data Analysis - Assignment 1 - Plot 4" )
...
plot(powerdata$timeStamp,powerdata$Global_active_power,type="l",xlab=NA,ylab="Global Active Power")

## Top-right; voltage vs time

plot(powerdata$timeStamp,powerdata$Voltage,type="l",xlab="datetime",ylab="Voltage")

## Bottom-left; same as plot 3 (minus the legend box)
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
   lty=c(1,1),lwd=c(1,1),col=c("black","red","blue"),bty="n")

## Bottom-right; reactive power vs time
